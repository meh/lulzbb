...
function register(option) {
    switch(option) {
        case 'username':
            ...
            POST(
                'username-error',
                '?in&user&register&check&username',
        ...
        case 'password':
            ...
            if (password_confirmation != '' || (password == '' && password_confirmation == '')) {
                POST(
                    'password-error',
                    '?in&user&register&check&password',
        ...
        case 'register':
            ...
            if (username_error.innerHTML == 'Ok.' && email_error.innerHTML == 'Ok.' && (password.length >= 6 && password.length <= 30)) {
                POST('middle', '?in&user&register&send', 'username='+rawurlencode(username)+'&email='+rawurlencode(email)+'&password='+rawurlencode(password));
            }
